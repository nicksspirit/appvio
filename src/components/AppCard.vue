<template>
  <div class="appcard relative">
    <div
      ...
      shadow-md px-2 py-3 my-1 flex flex-col align-center relative z-20"
    >
      ...
      <div class="appcard__controls flex justify-end">
        ...
        <button
          :class="{
            'appcard__controls__btn expand-btn mx-2 focus:outline-none rounded-full focus:shadow-outline': true,
    ...
    <transition name="slide-in-top">
      <div
        v-show="isExpanded"
        class="appcard__details max-w-sm m-auto rounded overflow-hidden 
        shadow-md px-2 py-3 my-1 flex flex-col align-center relative z-10"
      >
        <p class="px-2">
          {{ appData.description }}
        </p>
